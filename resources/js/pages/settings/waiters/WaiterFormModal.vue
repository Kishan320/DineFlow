          ...
          <form @submit.prevent="submit" class="p-5 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                :style="`background:var(--background);border-color:${errors.waiter_code ? 'var(--danger)' : 'var(--border)'};color:var(--foreground)`"
              />
            ...
            <div>
              ...
              <input
                ...
                type="text"
                class="w-full border rounded-lg px-3 py-2 text-sm outline-none"
                :style="`background:var(--background);border-color:${errors.name ? 'var(--danger)' : 'var(--border)'};color:var(--foreground)`"
              />
            ...
            <div>
              ...
              <input
                ...
                type="text"
                class="w-full border rounded-lg px-3 py-2 text-sm outline-none"
                :style="`background:var(--background);border-color:${errors.mobile ? 'var(--danger)' : 'var(--border)'};color:var(--foreground)`"
              />
...
const schema = yup.object({
  ...
  mobile:      yup.string().required('Mobile is required').max(20),
