...
const testimonials = [
  { id: 1, name: 'Priya Nair',            role: 'Food Writer, The Hindu',         image: 'https://ik.imagekit.io/dineflowimages/landing/image-25.png',  alt: 'Indian woman portrait', rating: 5, quote: "DineFlow is the closest I've come to a Michelin-star experience in India. The Rogan Josh alone is worth the trip from Mumbai — complex, soulful, and absolutely unforgettable.", occasion: 'Anniversary Dinner' },
  { id: 2, name: 'Rahul Sharma',           role: 'Managing Director, Apex Ventures', image: 'https://ik.imagekit.io/dineflowimages/landing/image-26.png', alt: 'Indian professional man portrait', rating: 5, quote: "We've hosted 12 client dinners at DineFlow this year. Every single time, our guests leave impressed. The private dining room and attentive service make it our go-to for important meetings.", occasion: 'Business Dining' },
  { id: 3, name: 'Anika Mehta',            role: 'Travel Blogger, Delhi Diaries',  image: 'https://ik.imagekit.io/dineflowimages/landing/image-27.jpg',                      alt: 'Young Indian woman portrait',      rating: 5, quote: "I've eaten at 200+ restaurants across India. DineFlow's tasting menu is the single best meal I've had in this country. Chef Arjun's storytelling through food is genuinely moving.", occasion: 'Solo Dining' },
  { id: 4, name: 'Vikram & Sunita Khanna', role: 'Regulars since 2012',            image: 'https://ik.imagekit.io/dineflowimages/landing/image-28.jpg',                      alt: 'Indian couple smiling',            rating: 5, quote: "We celebrate every anniversary here. Twelve years, twelve dinners, and each one better than the last. The staff remembers our preferences and the ambiance is simply magical.", occasion: 'Anniversary Tradition' },
];
