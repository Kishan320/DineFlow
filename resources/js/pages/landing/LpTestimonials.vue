...
const testimonials = [
  { id: 1, name: 'Priya Nair',            role: 'Food Writer, The Hindu',         image: 'https://img.rocket.new/generatedImages/rocket_gen_img_1ecb4aca8-1763296537332.png',  alt: 'Indian woman portrait', rating: 5, quote: "DineFlow is the closest I've come to a Michelin-star experience in India. The Rogan Josh alone is worth the trip from Mumbai — complex, soulful, and absolutely unforgettable.", occasion: 'Anniversary Dinner' },
