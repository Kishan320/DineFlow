...
const offers = [
  { id: 1, badge: 'Weekend Special',  title: 'Couples Dining Experience', description: 'A curated 5-course tasting menu for two with a complimentary bottle of sparkling wine. Fridays & Saturdays, 7pm onwards.', discount: '20% Off',   image: 'https://images.unsplash.com/photo-1723583534569-debad9948c49',                          alt: 'Romantic restaurant table',   cta: 'Book for Two',    accent: 'rgba(120,53,15,0.8)' },
  { id: 2, badge: 'Lunch Offer',       title: 'The Power Lunch',           description: 'Weekday business lunch — 3 courses, still water, and filter coffee. Served in 45 minutes or your next visit is complimentary.', discount: '₹999 Only', image: 'https://images.unsplash.com/photo-1714700167450-19c1ca2350a8',                          alt: 'Elegant business lunch',       cta: 'Reserve Lunch',   accent: 'rgba(41,37,36,0.8)' },
  { id: 3, badge: "Chef's Table",      title: 'Private Dining Experience', description: "An exclusive 8-course dinner at Chef Arjun's private table. Limited to 6 guests. Includes a kitchen tour and signed menu.",     discount: 'By Invite', image: 'https://img.rocket.new/generatedImages/rocket_gen_img_171eb2273-1772258259989.png', alt: "Private chef's table",         cta: 'Enquire Now',     accent: 'rgba(24,24,27,0.8)' },
];
</script>
