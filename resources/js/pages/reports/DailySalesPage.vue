    ...
    <div class="border rounded-xl shadow-card" style="background:var(--card);border-color:var(--border)">
      ...
      <div class="flex flex-wrap items-end gap-4 px-4 py-4 border-b" style="border-color:var(--border)">
        ...
        <div>
          ...
          <Select filter v-model="billType" class="border rounded-lg px-3 py-1.5 text-sm outline-none min-w-[160px]" style="background:var(--muted);border-color:var(--border);color:var(--foreground)" :options="[{label: 'Cash Bill', value: 'Cash Bill'}, {label: 'Credit Bill', value: 'Credit Bill'}, {label: 'Guest Bill', value: 'Guest Bill'}]" optionLabel="label" optionValue="value" placeholder="Select an Option" />
        </div>
