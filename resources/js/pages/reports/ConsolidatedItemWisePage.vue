    ...
    <div class="border rounded-xl shadow-card" style="background:var(--card);border-color:var(--border)">
      ...
      <div class="flex flex-wrap items-end gap-4 px-4 py-4 border-b" style="border-color:var(--border)">
        ...
        <div>
          ...
          <Select filter v-model="reportType" class="border rounded-lg px-3 py-1.5 text-sm outline-none min-w-[200px]" style="background:var(--muted);border-color:var(--border);color:var(--foreground)" :options="[{label: 'Consolidated Day Wise', value: 'Consolidated Day Wise'}, {label: 'Detailed Sales', value: 'Detailed Sales'}]" optionLabel="label" optionValue="value" />
        </div>
